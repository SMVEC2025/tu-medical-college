...
const collegeData = [
  ...
  ['12', 'Date of the First Letter of Permission (LoP) of MBBS & number of seats', 'IN PROCESS'],
  ['13', 'Status of Recognition', 'IN PROCESS'],
  ['14', 'Number of MBBS and PG broad specialty and super specialty students admitted in this session', 'IN PROCESS'],
  ...
  ['23', 'Number of Rooms in Men’s Hostel and students accommodated', 'Rooms- 110\nStudents accommodated- Not applicable'],
  ['24', 'Total Number of Rooms in Women’s Hostel and students accommodated', 'Rooms- 110\nStudents accommodated- Not applicable'],

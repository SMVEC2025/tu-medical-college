          ...
          <div className='col-lg-7 pe-xl-5'>
            <div className='pb-80 mb-lg-5 me-lg-5'>
              ...
              <h2 className='mb-24 wow bounceIn'>
                We nurture compassionate healers through science, service, and soul.              </h2>
              <p className='text-neutral-500 text-line-2 wow bounceInUp'>
                Rooted in values, yet reaching beyond boundaries, we offer medical education that is purposeful, progressive, and profoundly human.
              </p>
              <p className='text-neutral-500 text-line-2 mt-24 wow bounceInUp'>
                Certainly dedicated, skill refined through every pulse and breath; where empathy meets precision—healing becomes an art to be lived, not just learned.
              </p>
              {/* <Link
                to='/about'
